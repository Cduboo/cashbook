							...
							<div class="card">
								<div class="card-body">
									<ul class="nav nav-tabs" id="myTab" role="tablist">
										<li class="nav-item" role="presentation"><a class="nav-link" id="updateName-tab" data-bs-toggle="tab" href="#updateName" role="tab" aria-controls="updateName" aria-selected="true">회원정보 수정</a></li>
										<li class="nav-item" role="presentation"><a class="nav-link active" id="updatePw-tab" data-bs-toggle="tab" href="#updatePw" role="tab" aria-controls="updatePw" aria-selected="false">비밀번호 변경</a></li>
									...
									<div class="tab-content" id="myTabContent">
										<div class="tab-pane fade" id="updateName" role="tabpanel" aria-labelledby="updateName-tab">
										...
										<div class="tab-pane fade show active" id="updatePw" role="tabpanel" aria-labelledby="updatePw-tab">
