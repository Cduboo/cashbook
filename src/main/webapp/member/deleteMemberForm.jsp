	...
	<body>
		...
		<div class="container-scroller">
			...
			<div class="container-fluid page-body-wrapper" style="background-color: #F4F7FA;">
				...
				<!-- main -->
				<div class="container col-md-6 grid-margin stretch-card mt-5" style="height: 300px;">
					<div class="card">
						<div class="card-body">
							<p class="card-description">MYPAGE</p>
							<h4 class="card-title mb-5">Sign Out</h4>
							<%
								if(msg != null) {
							%>
								<div><%=msg%></div>
							...
							%>
							<form action="<%=request.getContextPath()%>/member/deleteMemberAction.jsp" method="post" class="forms-sample">
								<div class="form-group row">
									<label for="exampleInputPassword" class="col-sm-3 col-form-label">Password</label>
									<div class="col-sm-9">
										<input type="password" name="memberPw" class="form-control" id="exampleInputPassword" placeholder="Password">
									</div>
								</div>
